  ...
  return (
    <div className="details-section">
      ...
      <div className="details-section-details">
        <div className="detail-line"><h5>{city.cityName}</h5></div>
        ...
        <div className="detail-line">
          ...
          <p className="temp-tag tag2">{city.temp}</p>
        </div>
        <div className="detail-line">
          <p className="temp-tag tag1"> Temperature feeling:</p>
          <p className="temp-tag tag2">{city.tempFeelsLike}</p>
        </div>
        <div className="detail-line">
        ...
        <div className="detail-line">
          ...
          <p className="temp-tag tag2">{city.Humidity}</p>
        </div>
        <div className="detail-line">
